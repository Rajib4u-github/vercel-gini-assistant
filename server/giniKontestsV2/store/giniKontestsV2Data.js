...
let portfolio_data = {
    ...
    "allKontentsApisGlobalSearch_section": {
      sectionName : 'allKontentsApisGlobalSearch_section',
                ...
                parts: [
                    {
                        ...
                        desc: [
                          {type: 'wrap-open', key: {name: 'div', class: '', style: 'width: 100%;'}, itemStyle: 'display: inline-block; width: 100%; padding: 5px 10px 16px 10px;'},
                              {
                                type: 'input-type-text', event:
                                  ...
                                  key: {name: '', placeholder: 'Enter keywords to search kontests', style: 'width: 100%; background: white; padding: 8px;'},  itemStyle: 'display: inline-block; width: 85%; '
                              },
                          ...
                          {type: 'button', event: {eventName : "onClickButton(this, event, 'kontests_apis_custom_search')", eventType: 'onclick'}, key: {name: 'Choose Category', class:'public-apis-choose-category', style: 'font-size: 16px; padding: 10px 0px 10px 0px; width: 100%; position: relative; font-weight: 500; border: none !important; '}, itemStyle: 'white-space: initial;'},
    ...
    "kontestsApisLeftSideBarSearch_section": {
      sectionName : 'kontestsApisLeftSideBarSearch_section',
      dataSource: {type: 'API', url: 'https://kontests.net/api/v1/sites'},
                        ...
                        desc: [
                            {
                              ...
                              event: {
                                  ...
                                  argument : {dataSource: 'API', key: {name: 'siteCode'}, sectionName: 'kontestsApisBySite_section', targetSectionName: 'allPublicApis', baseUrl: 'https://kontests.net/api/v1/', category: 'kontests_by_site', whileSearchTargetSectionName: 'kontestsApisLeftSideBarSearch'},
                                  eventType: 'onclick'
                              },
                              key:{
                                  name: 'siteName',
                                  class:'default-theme-primary-color',
                                  style: 'font-size: 16px; padding: 10px 0px 10px 0px; display: block; width: 100%; position: relative; border: none !important; outline: none !important; background: brown; color: white; font-weight: lighter;'
                              },
    ...
    "kontestsApisRightSideBarSearch_section": {
      sectionName : 'kontestsApisSideBarSearch_section',
      block: {
          sections: [
            {
                // animationType: 'fade-up', animationDelay: null,
                        ...
                        desc: [
                            {
                              ...
                              key:{
                                  name: 'Future Contests',
                                  class:'default-theme-primary-color',
                                  style: 'font-size: 16px; padding: 10px 0px 10px 0px; display: block; width: 100%; position: relative; font-weight: 500; border: none !important; outline: none !important; background: #D1D5DB; color: brown; padding-left: 10px; cursor: pointer; '
                              },
                              itemStyle: 'white-space: initial;'
                            },
                            {
    ...
    "kontestsApisBySite_section": {
      sectionName : 'kontestsApisBySite_section',
                ...
                parts: [
                    {
                        ...
                        desc: [
                                {type: 'text', dataSource: 'API',
                                  addClass: {exp: '(item.name === "The Orkes Hack") ? "add-item-class-true-case" : "add-item-class-false-case"', expResult: ''},
                                  key: {name: 'name', class:'ellipse-line-one', style: 'font-size: 16px; padding: 3px 0px; display: block; width: 100%; position: relative; font-weight: 700; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;'}, itemStyle: 'white-space: initial;'
                                },
                                {type: 'text', dataSource: 'API', key: {name: 'duration', preHtml: '<span style="font-weight: 600; ">Duration : </span>', style: 'font-size: 14px;'}, itemStyle: 'white-space: initial;'},
                                {type: 'text', dataSource: 'API', key: {name: 'in_24_hours', preHtml: '<span style="font-weight: 600; ">In 24 Hours : </span>', class:'', style: 'font-size: 14px; padding: 3px 0px; display: block; width: 100%; position: relative; font-weight: 700;'}, itemStyle: 'white-space: initial;'},
                                {type: 'text', dataSource: 'API', key: {name: 'status', preHtml: '<span style="font-weight: 600; ">Status : </span>', class:'', style: 'font-size: 14px; padding: 3px 0px; display: block; width: 100%; position: relative; font-weight: 700;'}, itemStyle: 'white-space: initial;'},
                                {
                                    type: 'text',
                                    dataSource: 'API',
                                    applyFilter: {exp: 'new Date(item.start_time).toUTCString()', expResult: ''},
                                    key: {name: 'start_time', preHtml: '<span style="font-weight: 600; ">Start: </span>', class: '', style: 'font-size: 14px; padding-bottom: 3px; font-weight: 600; '},
                                    itemStyle: ' white-space: nowrap; overflow: hidden; text-overflow: ellipsis;'
                                },
                                {
                                  type: 'text',
                                  dataSource: 'API',
                                  applyFilter: {exp: 'new Date(item.end_time).toUTCString()', expResult: ''},
                                  key: {name: 'end_time', preHtml: '<span style="font-weight: 600; ">End: </span>', style: 'font-size: 14px; font-weight: 600;'},
                                  itemStyle: 'white-space: nowrap; overflow: hidden; text-overflow: ellipsis;'
                                },
                        ...
                        partStyle: 'display: inline-block; width: 32%; margin-left: 10px; margin-bottom: 10px; vertical-align: top; background: white; color: black; padding: 12px; float: left;'
                    },
                ],
                sectionClass: '',
                sectionStyle: ''
    ...
    "allPublicApis_section": {
      ...
      dataSource: {type: 'API', url: 'https://kontests.net/api/v1/all'},
      // dataSource: {type: 'DATA-SERVER', dataFilePath: '/publicApis/store/publicApisRawData.js'},
                ...
                parts: [
                    {
                        animationType: 'fade-up', animationDelay: null,
                        isDraggable  : false,
                        addClass: {exp: `(new Date(item.start_time) < new Date() && new Date(item.end_time) < new Date()) ? "background: gray; color: white;":((new Date(item.start_time) < new Date()) && (new Date(item.end_time) > new Date())) ? "background: brown; color: white;" : "background: orange; color: white;"`, expResult: ''},

                        desc: [
                                {type: 'text', dataSource: 'API', key: {name: 'site', class:'', style: 'font-size: 20px; padding: 3px 0px; display: block; width: 100%; position: relative; font-weight: 700;'}, itemStyle: 'white-space: initial; text-align: center;'},

                                {type: 'text', dataSource: 'API',
                                    // addStyle: {exp: '(item.name === "The Orkes Hack") ? "color: brown; " : " color: yellow;"', expResult: ''},
                                    key: {name: 'name', class:'', style: 'font-size: 16px; padding: 3px 0px; display: block; width: 100%; position: relative; font-weight: 600; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; color: gray;'}, itemStyle: 'white-space: initial;'
                                },
                                {
                                  type: 'text',
                                  dataSource: 'API',
                                  applyFilter: {exp: 'new Date(item.start_time).toUTCString()', expResult: ''},
                                  key: {name: 'start_time', preHtml: '<span style="font-weight: 600; ">Start: </span>', class: '', style: 'font-size: 14px; padding-bottom: 3px; font-weight: 600;'},
                                  itemStyle: ' white-space: nowrap; overflow: hidden; text-overflow: ellipsis; color: gray;  '
                                },
                                {
                                  type: 'text',
                                  dataSource: 'API',
                                ...
                                {type: 'text', dataSource: 'API',
                                    applyFilter: {exp: `
                                      ...
                                      getYoutubeLikeToDisplay(item.duration);
                                      `, expResult: ''},
                                    key: {name: 'duration', preHtml: '<span style="font-weight: 600; ">Duration : </span>', postHtml: '<span style="">HR</span>', style: 'font-size: 14px;'},
                                    itemStyle: 'white-space: initial; color: gray;'
                                },
                                {type: 'text', dataSource: 'API', key: {name: 'status', preHtml: '<span style="font-weight: 600; ">Status : </span>',class:'', style: 'font-size: 14px; padding: 3px 0px; display: block; width: 100%; position: relative; font-weight: 700;'}, itemStyle: 'white-space: initial; color: gray;'},
                                {type: 'text', dataSource: 'API', key: {name: 'in_24_hours', preHtml: '<span style="font-weight: 600; ">In 24 Hours : </span>', class:'', style: 'font-size: 22px; padding: 3px 0px; display: block; width: 100%; position: relative; font-weight: 700;'}, itemStyle: 'white-space: initial; color: gray;'},
                  ...
                  parts: [
                      {
                          ...
                          desc: [
                            ...
                            {type: 'wrap-open', key: {name: 'div', class: '', style: 'width: 100%;'}, itemStyle: 'display: inline-block; width: 30%; padding: 5px 10px 16px 10px;'},
                                {
                                  type: 'input-type-text', event:
                                    [
                                      {eventName : "onKeyUpInput(this, event, 'search_allKontestsApis')", eventType: 'onKeyUp'},
                            ...
                            {type: 'wrap-open', key: {name: 'div', class: '', style: 'width: 100%;'}, itemStyle: 'display: inline-block; width: auto; padding: 5px 10px 16px 10px;'},
                                {
                                  type: 'text',
                                  event: {
    ...
    "init_sections" : {
        values: [
          ...
          // {
          //   section: {name: 'kontestsApisRightSideBarSearch', id: '', class: 'mob-side-bar-search', style: 'position: relative; top: -60px; width: 13%; display: inline-block; float: right; '},
          //   menu: {name: 'About Me', style: '', method: '', icon: {name: 'user',type: 'bx', style: ''}},
          //   block: {class: '', style: ''},
          //   loader: {img: {imgUrl: 'static/img/generic_portfolio_image/loader/loader_wait.gif', alt: '', style: 'height: 100px; width: 100px; position: relative; margin-top: 15%; background: transparent; border-radius: 50px;'},  style: ''},
          //   template: {style: ''}
          // },
