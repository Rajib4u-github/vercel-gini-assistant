...
let sections_data = {
    ...
    "workcat_section": {
        ...
        passByArgument: {
              ...
              targetSectionName: 'publicOpenSourceLibraries',
              rawDataTargetProperty: 'Author'
        },
        lists: [
            {name : "All", type: 'list'},
            {name : "Facebook", type: 'list'},
            {name : "Google", type: 'list'},
            {name : "Microsoft", type: 'list'},
            {name : "Twitter", type: 'list'},
            {
              name: 'Query by text...', 
    ...
    "npmFilterByCategory_section": {
        sectionName : 'npmFilterByCategory_section',
        block: {
            sections: [
                        {
                            animationType: 'fade-up', animationDelay: null,
                            parts: [
                                {
                                    ...
                                    isDraggable  : true,
                                    desc: [
                                      {type: 'text', key: {name: 'by Facebook', class: '', style: 'font-size: 16px;background: brown; padding: 9px; color: white; '}, itemStyle: 'display: inline-block; '},
                                      {type: 'text', key: {name: 'by Google', class: '', style: 'font-size: 16px;background: brown; padding: 9px; color: white;'}, itemStyle: 'display: inline-block; '},
                                      {type: 'text', key: {name: 'by Microsoft', style: 'font-size: 16px; background: brown; padding: 9px; color: white;'}, itemStyle: 'display: inline-block;'},
                                      {type: 'text', key: {name: 'by Twitter', style: 'font-size: 16px; background: brown; padding: 9px; color: white;'}, itemStyle: 'display: inline-block;'},
                                    ],
                                    partStyle: 'display: inline-block; width: 98%; background: white; margin-right: 1rem; margin-bottom: 1rem; padding: 20px;  '
                                },
                            ],
                            sectionClass: '',
                ...
                parts: [
                    {
                        ...
                        // ],
                        partClass: 'collection-parts-mob-style  overlay-container',
                        partStyle: 'display: inline-block; width: 31%; margin-right: 10px; margin-bottom: 10px; vertical-align: top; background: white; color: black; padding: 15px; border: solid #e5e7eb;'
                    },
                ],
                sectionClass: '',
    ...
    "openSourceCategory_section": {
                ...
                defaultCategory : {name: '', style: 'background: '+default_style.themeColor+'; color: red !important; '},
                ...
                sectionStyle: 'position: relative; top: 90px; border; 1px solid red; '
    },
    
    "publicOpenSourceLibraries_section": {
      sectionName : 'publicOpenSourceLibraries_section',
      // dataSource: {type: 'API', url: 'https://api.publicapis.org/entries'},
      dataSource: {type: 'DATA-SERVER', dataFilePath: '/NPM_INFO/store/publicOpenSourceLibraries.js'},
    ...
    "publicOpenSourceRepositories_section": {
      sectionName : 'publicOpenSourceRepositories_section',
      // dataSource: {type: 'API', url: 'https://api.publicapis.org/entries'},
      dataSource: {type: 'DATA-SERVER', dataFilePath: '/NPM_INFO/store/publicOpenSourceRepositories.js'},
                ...
                parts: [
                    {
                        ...
                        desc: [
                          // {type: 'image', dataSource: 'API', key: {name: 'img', defaultValue: 'static/img/news/default_currents_news_img.png', style: 'width: 100%; height: 250px;'}, itemStyle: 'display: inline-block; width: 100%; float: left;'},
                            {type: 'wrap-open', key: {name: 'div', class: '', style: 'width: 100%;'}, itemStyle: 'display: inline-block; width: 100%; padding: 5px 10px 16px 10px;'},
                                {type: 'text', dataSource: 'API', key: {name: 'full_name', class:'default-theme-primary-color', style: 'font-size: 18px; padding: 3px 0px; display: block; width: 100%; position: relative; font-weight: 700;'}, itemStyle: 'white-space: nowrap; overflow: hidden; text-overflow: ellipsis;'},
                                {type: 'text', dataSource: 'API', key: {name: 'description', class: '', style: 'font-size: 13px; padding-bottom: 3px; '}, itemStyle: 'min-height: 65px; overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-box-orient: vertical; -webkit-line-clamp: 3;'},
                                ...
                                {type: 'text', dataSource: 'API', key: {name: 'license', preHtml: '<span style="font-weight: 600; ">Licence : </span>', style: 'font-size: 15px;'}, itemStyle: 'white-space: initial;'},
                                {type: 'text', dataSource: 'API', key: {name: 'rank', preHtml: '<span style="font-weight: 600; ">Rank : </span>', style: 'font-size: 15px;'}, itemStyle: 'white-space: initial;'},
    ...
    "publicOpenSourcePlatforms_section": {
      sectionName : 'publicOpenSourcePlatforms_section',
      // dataSource: {type: 'API', url: 'https://api.publicapis.org/entries'},
      dataSource: {type: 'DATA-SERVER', dataFilePath: '/NPM_INFO/store/publicOpenSourcePlatforms.js'},
          ...
          sections: [
            {
                ...
                parts: [
                    {
                        animationType: 'fade-up', animationDelay: null,
                        isDraggable  : false,
                        useAsPartStyle: {active : true, elementIndex: 4, elementValue: '', style: {property: 'background'}},
                        desc: [
                          // {type: 'image', dataSource: 'API', key: {name: 'img', defaultValue: 'static/img/news/default_currents_news_img.png', style: 'width: 100%; height: 250px;'}, itemStyle: 'display: inline-block; width: 100%; float: left;'},
                            {type: 'wrap-open', key: {name: 'div', class: '', style: 'width: 100%;'}, itemStyle: 'display: inline-block; width: 100%; padding: 5px 10px 16px 10px;'},
                                {type: 'text', dataSource: 'API', key: {name: 'name', class:'default-theme-primary-color', style: 'font-size: 18px; padding: 3px 0px; display: block; width: 100%; position: relative; font-weight: 700;'}, itemStyle: 'white-space: nowrap; overflow: hidden; text-overflow: ellipsis;'},
                                {type: 'text', dataSource: 'API', key: {name: 'default_language', preHtml: '<span style="font-weight: 600; "> Language: </span>', style: 'font-size: 15px; '}, itemStyle: 'white-space: initial;'},
                                {type: 'text', dataSource: 'API', key: {name: 'project_count', preHtml: '<span style="font-weight: 600; ">Project Count : </span>', style: 'font-size: 15px;'}, itemStyle: 'white-space: initial;'},
                                {type: 'text', visibility: false, dataSource: 'API', key: {name: 'color', class: '', style: 'font-size: 13px; padding-bottom: 3px; '}, itemStyle: 'min-height: 65px; overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-box-orient: vertical; -webkit-line-clamp: 3;'},
                ...
                sectionClass: '',
                sectionStyle: 'clear: both; margin-left: 6px; margin-right: 6px;'
                // sectionStyle: 'overflow-x: scroll; overflow-y: hidden; white-space: nowrap;',
              },
        ],
          blockStyle: '',
    ...
    "publicOpenSourcePlatformDependants_section": {
      sectionName : 'publicOpenSourcePlatformDependants_section',
      // dataSource: {type: 'API', url: 'https://api.publicapis.org/entries'},
      dataSource: {type: 'DATA-SERVER', dataFilePath: '/NPM_INFO/store/publicOpenSourcePlatformDependants.js'},
                        ...
                        desc: [
                          // {type: 'image', dataSource: 'API', key: {name: 'img', defaultValue: 'static/img/news/default_currents_news_img.png', style: 'width: 100%; height: 250px;'}, itemStyle: 'display: inline-block; width: 100%; float: left;'},
                            {type: 'wrap-open', key: {name: 'div', class: '', style: 'width: 100%;'}, itemStyle: 'display: inline-block; width: 100%; padding: 5px 10px 16px 10px;'},
                                ...
                                {type: 'text', dataSource: 'API', key: {name: 'license', preHtml: '<span style="font-weight: 600; ">Licence : </span>', style: 'font-size: 15px;'}, itemStyle: 'white-space: initial;'},
                                {type: 'text', dataSource: 'API', key: {name: 'rank', preHtml: '<span style="font-weight: 600; ">Rank : </span>', style: 'font-size: 15px;'}, itemStyle: 'white-space: initial;'},
                                {type: 'text', dataSource: 'API', key: {name: 'platform', preHtml: '<span style="font-weight: 600; ">Platform : </span>', style: 'font-size: 15px;'}, itemStyle: 'white-space: initial;'},
                        ...
                        event: [
                          {
                            eventName : 'onClickRedirectUrl(this, event)',
                            eventType: 'onclick',
                            argument : {dataSource: 'API', key: {name: 'package_manager_url', action: 'redirectUrl'}},
                            dataSetName: 'nav-links-data'
                          },
                        ],
                        partClass: 'collection-parts-mob-style  overlay-container',
                  ...
                  parts: [
                      {
                          ...
                          isDraggable  : true,
                          desc: [
                            {type: 'wrap-open', key: {name: 'div', class: '', style: 'width: 100%;'}, itemStyle: 'display: inline-block; width: 24%; padding: 0px 10px 0px 10px;'},
                                {
                              type: 'text',
                              key:{
                                  name: 'GINI-PUBLIC-APIS',
                                  class:'default-theme-primary-color',
                                  style: 'font-size: 22px; padding: 10px 0px 10px 0px; display: block; width: 100%; position: relative; font-weight: 600; border: none !important; outline: none !important; color: white; padding-left: 10px; '
                              },
                              itemStyle: 'white-space: initial; width: auto; display: inline-block; margin-left: 25%; '
                            },
                            {type: 'wrap-close', key: {name: 'div', class: '', style: ' '}, itemStyle: ''},



                            {type: 'wrap-open', key: {name: 'div', class: '', style: 'width: 100%;'}, itemStyle: 'display: inline-block; width: 50%; padding: 0px 10px 0px 10px; margin-left: 15%;'},
                                {
                                  type: 'input-type-text', event:
                                    [
                                    ...
                                    key: {name: '', placeholder: 'Enter keywords to search public apis', style: 'width: 100%; background: white; padding: 8px; border-radius: 50px; outline: none !important; '},  itemStyle: 'display: inline-block; width: 85%; '
                                },
                            {type: 'wrap-close', key: {name: 'div', class: '', style: ' '}, itemStyle: ''},



                            {type: 'wrap-open', key: {name: 'div', class: '', style: 'width: 100%;'}, itemStyle: 'display: inline-block; width: 100%; text-align: center; padding: 0px 10px 0px 10px;'},
                                {
                                  type: 'text',
                                  event: {
                                      eventName : "onClickButton(this, event, 'all_kontests')",
                                      argument : {key: {name: 'future_contests'}, sectionName: 'allPublicApis_section', targetSectionName: 'allPublicApis'},
                                      eventType: 'onclick'
                                  },
                                  key:{
                                      name: 'All Public Apis',
                                      class:'default-theme-primary-color ',
                                      style: 'font-size: 16px; padding: 10px 10px 10px 0px; display: block; width: 100%; position: relative; font-weight: 500; border: none !important; outline: none !important; color: white; padding-left: 10px; font-weight: 900;'
                                  },
                                  itemStyle: 'white-space: initial; width: auto; display: inline-block; cursor: pointer;',
                                  itemClass: 'nav-btn'
                                ...
                                },
                                {
                                  type: 'text',
                                  event: {
                                      eventName : "onClickButton(this, event, 'kontests_by_site')",
                                      argument : {key: {name: 'live_contests'}, sectionName: 'allPublicApis_section', targetSectionName: 'allPublicApis'},
                                      eventType: 'onclick'
                                  },
                                  key:{
                                      name: 'Public Web Hooks',
                                      class:'default-theme-primary-color ',
                                      style: 'font-size: 16px; padding: 10px 10px 10px 0px; display: block; width: 100%; position: relative; font-weight: 500; border: none !important; outline: none !important; color: white; padding-left: 10px; font-weight: lighter;'
                                  },
                                  itemStyle: 'white-space: initial; width: auto; display: inline-block; cursor: pointer;',
                                  itemClass: 'nav-btn'
                                ...
                                },
                                {
                                  ...
                                  event: {
                                      eventName : "onClickButton(this, event, 'kontests_by_site')",
                                      argument : {key: {name: 'played_contests'}, sectionName: 'allPublicApis_section', targetSectionName: 'allPublicApis'},
                                      eventType: 'onclick'
                                  },
                                  key:{
                                      name: 'Public JsonBin',
                          ...
                          partStyle: 'width: 100%;display: inline-block; background: brown; padding: 10px;',
                      },
                  ],
                  sectionClass: '',
                  sectionStyle: '',
    ...
    "headerNav_section": {
        ...
        brand: {
          values: [
            {type: 'text', key: {name: `Public Libraries`, class: '',  style: ''}, itemStyle: ''},
          ...
          values: [
            {
              type: 'link',
              key: {
                name: 'Public Platforms', class: '',  style: '', event: [
                  {
                    eventName : 'onClickHeaderNavigation(this, event)',
                    eventType: 'onclick',
                    argument : {
                      mapToSections: ['publicOpenSourcePlatforms',],
                    },
                    dataSetName: 'nav-links-data'
                  },
                ]
                ...
                event: [
                  {
                    eventName : 'onClickHeaderNavigation(this, event)',
                    eventType: 'onclick',
                    argument : {mapToSections: ['workcat', 'publicOpenSourceLibraries',]}, 
                    dataSetName: 'nav-links-data'
                  },
                ],
                itemStyle: ''
                ...
                event: [
                  {
                    eventName : 'onClickHeaderNavigation(this, event)',
                    eventType: 'onclick',
                    argument : {mapToSections: ['publicOpenSourceRepositories']},
                    dataSetName: 'nav-links-data'
                  },
                ],
                itemStyle: ''
                ...
                event: [
                  {
                    eventName : 'onClickHeaderNavigation(this, event)',
                    eventType: 'onclick',
                    argument : {mapToSections: ['publicOpenSourcePlatformDependants']},
                    dataSetName: 'nav-links-data'
                  },
                ],
                itemStyle: ''
    ...
    "all_sections" : {
        values: [
          ...
          { 
            section: {name: 'allPublicApisDatabase', id: '', class: 'desktop-main-section-width-90 mob-full-width main-content-sec-position', style: 'display: block; margin: auto;'},
            menu: {name: 'Open Source Libraries', style: '', method: '', icon: {name: 'user',type: 'bx', style: ''}},
            block: {class: '', style: ''},
          ...
          { 
            section: {name: 'publicOpenSourcePlatformDependants', id: '', class: 'desktop-main-section-width-90 mob-full-width main-content-sec-position ', style: 'display: block; margin: auto; '},
            menu: {name: 'Open Source Libraries', style: '', method: '', icon: {name: 'user',type: 'bx', style: ''}},
            block: {class: '', style: ''},
            loader: {img: {imgUrl: 'static/img/generic_portfolio_image/loader/loader_wait.gif', alt: '', style: 'height: 100px; width: 100px; margin-left: 45%; position: relative; margin-top: 15%; background: transparent; border-radius: 50px;'},  style: ''},
            template: {style: ''}
          ...
          { 
            section: {name: 'publicOpenSourceRepositories', id: '', class: 'desktop-main-section-width-90 mob-full-width main-content-sec-position', style: 'display: block; margin: auto;'},
            menu: {name: 'Open Source Libraries', style: '', method: '', icon: {name: 'user',type: 'bx', style: ''}},
            block: {class: '', style: ''},
            loader: {img: {imgUrl: 'static/img/generic_portfolio_image/loader/loader_wait.gif', alt: '', style: 'height: 100px; width: 100px; margin-left: 45%; position: relative;  background: transparent; border-radius: 50px;'},  style: ''},
            template: {style: ''}
          },
          { 
            section: {name: 'publicOpenSourceLibraries', id: '', class: '', style: 'display: inline-block; width: 95%; float: right; padding-left: 5px; position: relative; top: 105px; '},
            menu: {name: 'Open Source Libraries', style: '', method: '', icon: {name: 'user',type: 'bx', style: ''}},
            block: {class: '', style: ''},
            loader: {img: {imgUrl: 'static/img/generic_portfolio_image/loader/loader_wait.gif', alt: '', style: 'height: 100px; width: 100px; margin-left: 45%; position: relative; background: transparent; border-radius: 50px;'},  style: ''},
            template: {style: ''}
          ...
          { 
            section: {name: 'publicOpenSourcePlatforms', id: '', class: 'desktop-main-section-width-90 mob-full-width main-content-sec-position', style: 'display: block; margin: auto; '},
            menu: {name: 'Open Source Libraries', style: '', method: '', icon: {name: 'user',type: 'bx', style: ''}},
            block: {class: '', style: ''},
            loader: {img: {imgUrl: 'static/img/generic_portfolio_image/loader/loader_wait.gif', alt: '', style: 'height: 100px; width: 100px; margin-left: 45%; position: relative; margin-top: 15%; background: transparent; border-radius: 50px;'},  style: ''},
            template: {style: ''}
          ...
          { 
            section: {name: 'allPublicApisJsonBin', id: '', class: 'desktop-main-section-width-80 mob-full-width main-content-sec-position', style: 'display: block; margin: auto; '},
            menu: {name: 'Open Source Libraries', style: '', method: '', icon: {name: 'user',type: 'bx', style: ''}},
            block: {class: '', style: ''},
            loader: {img: {imgUrl: 'static/img/generic_portfolio_image/loader/loader_wait.gif', alt: '', style: 'height: 100px; width: 100px; margin-left: 45%; position: relative; margin-top: 15%; background: transparent; border-radius: 50px;'},  style: ''},
            template: {style: ''}
          ...
          
          {
            ...
            menu: {name: '', style: '', method: '', icon: {name: 'user',type: 'bx', style: ''}},
            block: {class: '', style: 'position: relative; width: 90; margin-left: 5%;'},
            loader: {img: {imgUrl: 'static/img/generic_portfolio_image/loader/loader_wait.gif', alt: '', style: ''},  style: ''},
            template: {style: ''}
          },
          {
            section: {name: 'npmFilterByCategory', id: '', class: '', style: ''},
            menu: {name: '', style: '', method: '', icon: {name: 'user',type: 'bx', style: ''}},
            block: {class: '', style: 'position: relative; width: 90; margin-left: 5%;'},
            loader: {img: {imgUrl: 'static/img/generic_portfolio_image/loader/loader_wait.gif', alt: '', style: ''},  style: ''},
            template: {style: ''}
          ...
          { 
            section: {name: 'allPublicApisMessageQueue', id: '', class: 'desktop-main-section-width-80 mob-full-width main-content-sec-position', style: 'display: inline-block; float: right; '},
            menu: {name: 'Open Source Libraries', style: '', method: '', icon: {name: 'user',type: 'bx', style: ''}},
            block: {class: '', style: ''},
            loader: {img: {imgUrl: 'static/img/generic_portfolio_image/loader/loader_wait.gif', alt: '', style: 'height: 100px; width: 100px; margin-left: 45%; position: relative; margin-top: 15%; background: transparent; border-radius: 50px;'},  style: ''},
            template: {style: ''}
          ...
          { 
            section: {name: 'allPublicApisWebhooks', id: '', class: 'desktop-main-section-width-80 mob-full-width main-content-sec-position', style: 'display: inline-block; float: right; '},
            menu: {name: 'Open Source Libraries', style: '', method: '', icon: {name: 'user',type: 'bx', style: ''}},
            block: {class: '', style: ''},
            loader: {img: {imgUrl: 'static/img/generic_portfolio_image/loader/loader_wait.gif', alt: '', style: 'height: 100px; width: 100px; margin-left: 45%; position: relative; margin-top: 15%; background: transparent; border-radius: 50px;'},  style: ''},
            template: {style: ''}
          ...
          { 
            section: {name: 'allPublicApisMockApiServer', id: '', class: 'desktop-main-section-width-80 mob-full-width main-content-sec-position', style: 'display: inline-block; float: right;'},
            menu: {name: 'Open Source Libraries', style: '', method: '', icon: {name: 'user',type: 'bx', style: ''}},
            block: {class: '', style: ''},
            loader: {img: {imgUrl: 'static/img/generic_portfolio_image/loader/loader_wait.gif', alt: '', style: 'height: 100px; width: 100px; margin-left: 45%; position: relative; margin-top: 15%; background: transparent; border-radius: 50px;'},  style: ''},
            template: {style: ''}
          ...
          { 
            section: {name: 'publicOpenSourceLibraries', id: '', class: 'desktop-main-section-width-80 mob-full-width main-content-sec-position', style: 'display: inline-block; float: right; '},
            menu: {name: 'Open Source Libraries', style: '', method: '', icon: {name: 'user',type: 'bx', style: ''}},
            block: {class: '', style: ''},
            loader: {img: {imgUrl: 'static/img/generic_portfolio_image/loader/loader_wait.gif', alt: '', style: 'height: 100px; width: 100px; margin-left: 45%; position: relative; margin-top: 15%; background: transparent; border-radius: 50px;'},  style: ''},
            template: {style: ''}
...

          {
            ...
            menu: {name: 'About Me', style: '', method: '', icon: {name: 'user',type: 'bx', style: ''}},
            block: {class: '', style: 'background: ghostwhite;'},
            loader: {img: {imgUrl: 'static/img/generic_portfolio_image/loader/loader_wait.gif', alt: '', style: 'height: 100px; width: 100px; margin-left: 45%; position: relative; margin-top: 15%; background: transparent; border-radius: 50px;'},  style: ''},
            template: {style: ''}
          },
          { 
            section: {name: 'allPublicApis', id: '', class: '', style: 'display: inline-block; width: 80%; float: right; padding-left: 5px; position: relative; top: 105px;'},
            menu: {name: 'About Me', style: '', method: '', icon: {name: 'user',type: 'bx', style: ''}},
            block: {class: '', style: ''},
            loader: {img: {imgUrl: 'static/img/generic_portfolio_image/loader/loader_wait.gif', alt: '', style: 'height: 100px; width: 100px; margin-left: 45%; position: relative; margin-top: 15%; background: transparent; border-radius: 50px;'},  style: ''},
            template: {style: ''}
           ...
           { 
            section: {name: 'indianApiIndStocksNSEMostActive', id: '', class: '', style: 'display: inline-block; width: 80%; float: right; padding-left: 5px; position: relative; top: 105px;'},
            menu: {name: 'About Me', style: '', method: '', icon: {name: 'user',type: 'bx', style: ''}},
            block: {class: '', style: ''},
            loader: {img: {imgUrl: 'static/img/generic_portfolio_image/loader/loader_wait.gif', alt: '', style: 'height: 100px; width: 100px; margin-left: 45%; position: relative; margin-top: 15%; background: transparent; border-radius: 50px;'},  style: ''},
            template: {style: ''}
          ...
          {
              section: {name: 'workcat', id: '', class: '', style: 'position: relative; top: 90px; left: 15%; padding-bottom: 0px;'},
    ...
    "init_sections" : {
        values: [
          ...
          // {
          //   section: {name: 'npmFilterByCategory', id: '', class: '', style: 'position: relative; top: 100px;'},
          //   menu: {name: '', style: '', method: '', icon: {name: 'user',type: 'bx', style: ''}},
          //   block: {class: '', style: 'position: relative; width: 90; margin-left: 5%;'},
          //   loader: {img: {imgUrl: 'static/img/generic_portfolio_image/loader/loader_wait.gif', alt: '', style: ''},  style: ''},
          //   template: {style: ''}
          // },
          // {
          //     section: {name: 'workcat', id: '', class: '', style: 'position: relative; top: 90px; left: 15%;'},
          //     menu: {name: 'Work Category', style: '', method: '', icon: {name: 'file-blank',type: 'bx', style: ''}},
          //     block: {class: '', style: 'padding: 12px; width: 90%; margin: auto; scrollbar-color: var(--default-theme-color) white;'},
          //     loader: {img: {imgUrl: 'static/img/generic_portfolio_image/loader/loader_wait.gif', alt: '', style: ''},  style: ''},
          //     template: {style: ''}
