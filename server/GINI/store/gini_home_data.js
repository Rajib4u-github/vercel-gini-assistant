...
let sections_data = {
    ...
    "headerNav_section": {
        ...
        navigation: {
          values: [
            // {type: 'link', key: {name: 'HOME', class: '',  style: '', event: [{eventName : 'onClickHeaderNavigation(this, event)', eventType: 'onclick', argument : {mapToSections: ['about','skills','facts']}, dataSetName: 'nav-links-data'}, ]},  itemStyle: ''},
            {
              type: 'link',
              key: {
                name: 'PRODUCTS',
                ...
                event: [
                  {
                    ...
                    eventType: 'onclick',
                    argument : {mapToSections: ['products']},
    ...
    "mobileSideNavBar_section": {
                sectionName : 'mobileSideNavBar_section',
                block: {
                    sections: [
                                {
                                    animationType: 'fade-up', animationDelay: null,
                                    parts: [
                                        {
                                            animationType: 'fade-up', animationDelay: null,
                                            desc: [
                                              {type: 'text', key: {name: 'Gini-services', class: 'default-theme-color default-outline-color', style: 'display: inline-block; font-size: 28px;font-weight: 700;width: 100%; '}, itemStyle: 'display: inline-block; width: 100%; padding: 0px 10px; float: left;'},
                                            ],
                                            partStyle: 'width: 100%;display: inline-block;  position: relative; text-align: center;padding: 30px 20px;',
                                        },
                                        {
                                            animationType: 'fade-up', animationDelay: null,
                                            desc: [
                                              {
                                                ...
                                                key: {
                                                  name: 'PRODUCTS',
                                                  class: '',
                                                  style: 'width: 100%;border-radius: 15px;margin-bottom: 10px;padding: 5px;border: none;',
                                                  itemStyle: ''
                                                },
                                                event: [
                                                  {
                                                    eventName : 'onClickMobileSideNavBarItem(this, event)',
                                                    eventType: 'onclick',
                                                    argument : {mapToSections: ['products']},
                                                    dataSetName: 'nav-links-data'
                                                  },
