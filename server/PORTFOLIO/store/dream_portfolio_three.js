...
let portfolio_data = {
            ...
            sections: [
                        {
                            ...
                            parts: [
                                ...
                                },
                                {
                                    ...
                                    desc: [
                                      {type: 'text', key: {name: 'Rajib karmakar : dream portfolio three', class: 'default-theme-color default-outline-color', style: ' font-size: 28px; font-weight: 700; width: 100%; '}, itemStyle: 'display: inline-block; padding: 0px 10px; width: 100%;'},
    ...
    "myProfiles_section": {
        profiles: ["My Engineering Portfolio", "my_dream_profile", "new_portfolio_file"]
    },
