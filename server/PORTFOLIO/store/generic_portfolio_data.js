...
let portfolio_data = {
                          ...
                          parts: [
                              {
                                  animationType: 'fade-up', animationDelay: null,
                                  desc: [
                                    {type: 'text', key: {name: 'My Engineering Profile', class: 'default-theme-color default-outline-color',  style: 'display: inline-block; font-size: 28px;font-weight: 700;width: 100%; '}, itemStyle: 'display: inline-block;  padding: 0px 10px; float: left; width: 100%;'},
                                  ],
            ...
            sections: [
                        {
                            ...
                            parts: [
                                ...
                                },
                                {
                                    ...
                                    desc: [
                                      {type: 'text', key: {name: 'Rajib karmakar : generic portfolio file', class: 'default-theme-color default-outline-color', style: ' font-size: 28px; font-weight: 700; width: 100%; '}, itemStyle: 'display: inline-block; padding: 0px 10px; width: 100%;'},
                          ...
                          parts: [
                              ...
                              },
                              {
                                  ...
                                  desc: [
                                    ...
                                    {type: 'icon', key: {name: 'edit', type: 'font-awesome', style: 'font-size: 18px; color: red;  position: relative; color: white; padding-top: 10px;'}, itemStyle: 'display: inline-block; '},
                                    {type: 'icon', key: {name: 'trash-o', type: 'font-awesome', style: 'font-size: 18px; color: red;  position: relative; color: white; padding-top: 10px;'}, itemStyle: 'display: inline-block; '},
                        ...
                        parts: [
                          {
                              ...
                              partStyle: 'display: inline-block; width: 98%; background: white; margin-top: 2rem; margin-bottom: 1rem;',
                          },
                        ]
                      }
        ],
    ...
    "theme_section": {
      sectionName : 'portfolio_theme_section',
      block: {
          sections: [
                      {
                          parts: [
                          ...
                          parts: [
                              ...
                              },
                              {
                                  ...
                                  desc: [
                                    ...
                                    {type: 'input-type-text', event: {eventName : "onKeyUpInputs(this, event, 'input_new_section_name')", eventType: 'onkeyup', argument:{ enableBtnId: 'btn_create_new_section', hideTextId: 'err_msg_create_new_section_name', removeClass: 'default-disabled-bg-color', addClass: 'default-background-color'} }, key: {name: '', class:'custom-theme-bb-2 no-outline', style: 'width: 100%; background: white; padding: 8px; ', id: 'input_new_section_name', placeholder: 'Enter your section name...'},  itemStyle: 'display: block; '},
                                    ...
                                    {type: 'all-sections-drop-down', key: {name: 'createNewSection_allSections', id: 'createNewSection_allSections', placeholder: 'Select an section as reference...',  class: 'default-theme-color ',  style: 'display: inline-block; font-size: 16px;font-weight: 400;width: 100%; position: relative; top: 1rem; padding: 8px; border: none; border-bottom: 2px solid var(--default-theme-color);'}, itemStyle: 'display: inline-block;  float: left; width: 100%; margin-bottom: 16px; '},
                                    {type: 'button', event: {eventName : "onClickCreateNewSection(this, event)", eventType: 'onclick', argument: {state: "create_new_section", mapToId: "input_new_section_name"} }, key: {name: 'Continue', id:'btn_create_new_section', class: 'default-disabled-bg-color default-outline-color ', style: 'font-size: 20px; font-weight: 500; width: 100%; padding: 12px;  border: none; color: white; border-radius: 6px; ', disabled: true}, itemStyle: 'display: inline-block; width: 100%; margin-top: 200px; outline: none !important;'},
                                  ],
                              ...
                              //     partStyle: 'width: 100%;display: inline-block; float: right;',
                              // },
    ...
    "createNewProfileModal_section": {
      sectionName : 'create_new_profile_template',
      block: {
          sections: [
                      {
                          animationType: 'fade-up', animationDelay: null,
                          parts: [
                              ...
                              },
                              {
                                  animationType: 'fade-up', animationDelay: null,
                                  desc: [
                                    {type: 'text', key: {name: `Let's start with a name for your new <span style="font-weight: 700; color: black; "> <i> Profile </i> </span> `, class: 'default-theme-color ',  style: 'display: inline-block; font-size: 28px;font-weight: 700;width: 100%; '}, itemStyle: 'display: inline-block;  float: left; width: 100%; margin-bottom: 16px; '},
                                    {type: 'input-type-text', event: {eventName : "onKeyUpInputs(this, event, 'input_new_profile_name')", eventType: 'onkeyup', argument:{ enableBtnId: 'btn_create_new_profile', hideTextId: 'err_msg_create_new_section_name', removeClass: 'default-disabled-bg-color', addClass: 'default-background-color'} }, key: {name: '', class:'custom-theme-bb-2 no-outline', style: 'width: 100%; background: white; padding: 8px; ', id: 'input_new_profile_name', placeholder: 'Enter your Profile name...'},  itemStyle: 'display: block; '},
                                    {type: 'text', key: {name: 'Profile name is required.', id: 'err_msg_create_new_section_name', class: 'default-theme-color default-outline-color',  style: 'display: block; font-size: 13px; color: red; font-weight: 700;width: 100%; '}, itemStyle: 'display: inline-block;  padding: 0px 10px; float: left; width: 100%;'},
                                    {type: 'button', event: {eventName : "onClickCreateNewSection(this, event)", eventType: 'onclick', argument: {state: "create_new_profile", mapToId: "input_new_profile_name"} }, key: {name: 'Create Profile', id:'btn_create_new_profile', class: 'default-disabled-bg-color default-outline-color ', style: 'font-size: 20px; font-weight: 500; width: 100%; padding: 12px;  border: none; color: white; ', disabled: true}, itemStyle: 'display: inline-block; width: 100%; margin-top: 100px;'},
                                  ],
                                  partStyle: 'width: 58%; display: inline-block; float: left;',
                              },
