...
var SHOPPING_APP_DATA = require(ROOT_DIR+'/server/RESTAURANT/store/restaurant_home_data.js').sections_data;


function get_section_data(sectionName){
  return SHOPPING_APP_DATA[sectionName];
}




let shopping_app_services = {
...
module.exports.shopping_app_services = shopping_app_services;
