...
// var MUSIC_SERVICES = require(ROOT_DIR+'/server/MUSIC/controllers/restaurantApp.controller.js');
var MUSIC_APP_DATA = require(ROOT_DIR+'/server/MUSIC/store/music_app_data.js').sections_data;
var DUMMY_ZOMATO_DATA = require(ROOT_DIR+'/server/MUSIC/store/zomato_app_data.js');
...
module.exports.music_app_services = music_app_services;
