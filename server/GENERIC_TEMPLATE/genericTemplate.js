...
function getIconTemplate(arguments, item){
    // console.log("&&&&&&&& calling get icon type components ======");
    let template = '';
    let iconName = 'ok';
    if(item !== null && item !== undefined && item.style !== null && item.style !== undefined && item.style !== ''){
        arguments.style += item.style;
    }
    if(item !== null && item !== undefined && item.iconName !== null && item.iconName !== undefined && item.iconName !== ''){
        iconName = item.iconName;
    }
    if(arguments.iconType === "glyphicon"){
        template += '<span class="glyphicon glyphicon-'+iconName+'" style="'+arguments.style+'"></span>';
    }else if(arguments.iconType === "fontAwesome"){
...
function getImageTemplate(imageOrIconPath, arguments, item){
  ...
  if(arguments.prefixTemplate !== null && arguments.prefixTemplate !== undefined && arguments.prefixTemplate !== ''){
      template = arguments.prefixTemplate+''+ template;
  }
...
//            method += ',';
  ...
  if(arguments.postfixTemplate !== null && arguments.postfixTemplate !== undefined && arguments.postfixTemplate !== ''){
      template =  template +''+ arguments.postfixTemplate;
  }
...
function getLeftImagewithDescTemplate(templateData, style){
  ...
  for(var key in style.defaults){
      ...
      }else if(key !== "descriptionTemplateStyle" && key !== "imageTemplateStyle"){
...
function getTopImagewithDescTemplate(templateData,style){
  ...
  if(templateData.descTemplate !== null && templateData.descTemplate !== undefined && templateData.descTemplate !== ''){
        descriptionTemplateStyle = "padding: 1rem;"+descriptionTemplateStyle;
  }
  let template = `

      <div class="row" style="`+customStyle+`">
          <div class="" style=" `+imageTemplateStyle+`">
              `+templateData.imageTemplate+`
          </div>
          <div class="" style="`+descriptionTemplateStyle+`">
               `+templateData.descTemplate+`
          </div>
      </div>
  `;
...
function getRightImagewithDescTemplate(templateData, style){
  let customStyle = '';
  let descriptionTemplateStyle = '';
  let imageTemplateStyle = '';
  if(style.defaults.descriptionTemplateStyle !== undefined){
  ...
  <div style="background-color: white;">
        <div class="">
          <div class="row" style="padding: 5px;">
              <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 col-7" style=" `+descriptionTemplateStyle+`">
                  `+templateData.descTemplate+`
              </div>
              <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 col-5" style=" padding: 5px; `+imageTemplateStyle+`">
                  `+templateData.imageTemplate+`
              </div>
          </div>
        </div>
              ...
              for (var i = 0; i < argList.length; i++) {
                      ...
                      if(argList[i].subkey === null){
                            ...
                            if(argList[i].type === "image"){
                                    if(payload.style.imgPos === "none"){
                                        templateData.descTemplate = getImageTemplate(item[argList[i].key], argList[i], item);
                                    }else{
                            ...
                            }else if(argList[i].type === "icon"){
                                        templateData.descTemplate += getIconTemplate(argList[i], item);
