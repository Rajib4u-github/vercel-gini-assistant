                           ...
                           parts: [
                               {
                                   ...
                                   isDraggable  : true,
                                   desc: [
                                     {type: 'text', key: {name: 'My name is avisekh randi.... khanki magisss....', class: ' default-outline-color custom-primary-font-color', style: 'display: inline-block; font-size: 14px; width: 100%;'}, itemStyle: 'display: inline-block; width: 100%; padding: 0px 10px; float: left;'},
                                     {type: 'text', key: {name: 'Or maa mashi ek korte habe....', class: ' default-theme-color default-outline-color', style: 'display: inline-block;  font-size: 36px; '}, itemStyle: 'display: inline-block; width: 100%; padding: 10px 10px; float: left;'},
                               ...
                               },
                               {
                                   animationType: 'fade-up', animationDelay: 50,
                                   desc: [
                                     {type: 'text', key: {name: `bal chal bal chal bal chal bal chalbal chal`, class: ' default-outline-color', style: ' font-size: 26px; font-weight: 700; width: 100%; '}, itemStyle: 'display: inline-block; padding: 0px 10px; width: 100%;'},
